...
public class MergeSortingController {
    ...
    void startOnAction(ActionEvent event) {
        if (array != null) {
            ...
            complex.mergeSort(arrayOrdenado, 0, arrayOrdenado.length - 1);
            actualizarTableView(SortedArrayableView1, arrayOrdenado);
            if (complex.getTempArray() != null) {
                actualizarTableView(noSortedArrayableView1, complex.getTempArray());
            }
